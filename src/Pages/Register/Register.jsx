                ...
                <div>
                  ...
                  <div className='mt-2.5 relative text-gray-400 focus-within:text-gray-600'>
                    <input
                      ...
                      className='block w-full py-4 pl-10 pr-4 text-gray-500  transition-all duration-200 border border-gray-200 rounded-md bg-gray-50 focus:outline-none focus:border-blue-600 focus:bg-white caret-blue-600 file:bg-gray-200 file:text-gray-700 file:text-sm file:px-4 file:py-1 file:border-none file:rounded-full'
                    />
                  </div>
                  {errors.image && (
                    <span className='text-red-600 mt-8'>Image is required</span>
                  )}
                </div>
